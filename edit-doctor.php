...
if(isset($_REQUEST['save-doc']))
{
      ...
      $update_query = mysqli_query($connection, "update tbl_employee set first_name='$first_name', last_name='$last_name', username='$username', emailid='$emailid', department='$department', password='$pwd',  dob='$dob', employee_id='$employee_id', joining_date = '$joining_date', gender='$gender', address='$address', phone='$phone',  bio='$bio',  status='$status' where id='$id'");
      if($update_query>0)
      {
