...
include('includes/connection.php');
    ...
    if(isset($_REQUEST['add-patient']))
    {
      ...
      $insert_query = mysqli_query($connection, "insert into tbl_patient set first_name='$first_name', last_name='$last_name', username='$username', email='$emailid', dob='$dob', gender='$gender', patient_type='$patient_type', address='$address', phone='$phone', status='$status'");
